<template>
        ...
        <div class="row">
            ...
            <b>Your Devices: </b>
                <div class="p-2" v-for="device, index in devices" :key="index">
                    <p>{{index + 1}} - {{device.Title}} - {{device.Certificate}} <b-button v-b-modal.modal-1 size="sm">Issue Certificate</b-button></p>
    ...
    <b-modal ok-title="Issue Certificate" header-bg-variant="dark" header-text-variant="light" ok-variant="success" cancel-variant="danger" id="modal-1" title="Issue Certificate">
